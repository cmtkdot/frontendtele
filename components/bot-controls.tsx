...
export function BotControls() {
  ...
  const handleSendCommand = async () => {
    ...
    try {
      const response = await fetch(`https://api.telegram.org/bot${config.telegram.botApi}/sendMessage`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        body: JSON.stringify({
          chat_id: '@xdelo_mediabot',
          text: command,
        }),
      });
    ...
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="space-y-2 pt-2">
        ...
        <Button
          ...
          asChild
        >
          <a href={`https://t.me/${config.telegram.botUsername}`} target="_blank" rel="noopener noreferrer">
